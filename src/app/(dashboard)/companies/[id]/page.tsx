  ...
  return (
    <div style={{
      ...
      <div style={{ marginBottom: "48px" }}>
        <div style={{ fontSize: "11px", letterSpacing: "0.08em", fontWeight: 500, color: "rgba(26,24,20,0.35)", marginBottom: "10px" }}>
          01 — COMPANY PROFILE
        </div>
        <h1 style={{ fontFamily: "var(--font-lora)", fontSize: "36px", fontWeight: 400, margin: "0 0 14px", lineHeight: 1.2, letterSpacing: "-0.01em" }}>
      ...
      <div style={{ height: "0.5px", background: "rgba(26,24,20,0.1)", marginBottom: "48px" }} />

      <div style={{ marginBottom: "48px" }}>
        <div style={{ fontSize: "11px", letterSpacing: "0.08em", fontWeight: 500, color: "rgba(26,24,20,0.35)", marginBottom: "24px" }}>
          02 — AT A GLANCE
        </div>
        <div style={{ display: "grid", gridTemplateColumns: "repeat(4, 1fr)", borderTop: "0.5px solid rgba(26,24,20,0.1)" }}>
          {[
            ...
            {[
              ...
              <div key={row.label} style={{ display: "flex", justifyContent: "space-between", alignItems: "baseline", padding: "10px 0", borderBottom: "0.5px solid rgba(26,24,20,0.07)", gap: "16px" }}>
                ...
                {row.isLink && row.value ? (
                  <a href={String(row.value).startsWith("http") ? String(row.value) : `https://${row.value}`} target="_blank" rel="noopener noreferrer" style={{ fontSize: "13px", color: "#1A1814", textDecoration: "none", borderBottom: "0.5px solid rgba(26,24,20,0.25)" }}>
      ...
      <div style={{ marginBottom: "48px" }}>
        <div style={{ fontSize: "11px", letterSpacing: "0.08em", fontWeight: 500, color: "rgba(26,24,20,0.35)", marginBottom: "24px" }}>04 — FUNDING HISTORY</div>
      ...
      <div style={{ marginBottom: "48px" }}>
        <div style={{ fontSize: "11px", letterSpacing: "0.08em", fontWeight: 500, color: "rgba(26,24,20,0.35)", marginBottom: "24px" }}>05 — INTEL SIGNALS</div>
        <div style={{ padding: "32px", border: "0.5px solid rgba(26,24,20,0.08)", borderRadius: "6px", textAlign: "center" }}>
      ...
      <div style={{ marginBottom: "48px" }}>
        <div style={{ fontSize: "11px", letterSpacing: "0.08em", fontWeight: 500, color: "rgba(26,24,20,0.35)", marginBottom: "24px" }}>06 — RELATED COMPANIES</div>
        <div style={{ fontFamily: "var(--font-lora)", fontSize: "13px", color: "rgba(26,24,20,0.25)", fontStyle: "italic", padding: "12px 0" }}>
